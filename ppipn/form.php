...
echo $ppipn->showForm ( "awei.tian-facilitator@qq.com", "http://" . $_SERVER ["HTTP_HOST"] . "/return/success.php", "http://" . $_SERVER ["HTTP_HOST"] . "/return/error.php", "http://" . $_SERVER ["HTTP_HOST"] . "/return/ipn.php");
?>